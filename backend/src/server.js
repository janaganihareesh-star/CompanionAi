...
app.get('/', (req, res) => {
  ...
  res.send(`<h2>Companion AI Backend API is running successfully.</h2><p>Please use the frontend URL (e.g., <a href="${frontendUrl}">${frontendUrl}</a>) to access the application interface.</p>`);
});

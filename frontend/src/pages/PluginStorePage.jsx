...
export const MOCK_PLUGINS = [
  ...
  { id: 'ola', name: 'Ola', iconText: 'O', iconBg: '#D7DF23', iconColor: '#000000', desc: 'Book a ride in India', category: 'Lifestyle', developer: 'Ola Cabs', website: 'olacabs.com', version: '2.1.0', capabilities: 'Interactive', longDesc: 'Book cabs, autos, and bikes across India instantly.' },
  ...
  { id: 'bookmyshow', name: 'BookMyShow', iconText: 'BMS', iconBg: '#F84464', iconColor: '#FFFFFF', desc: 'Movie & Event Tickets', category: 'Lifestyle', developer: 'Bigtree Entertainment', website: 'bookmyshow.com', version: '3.0.0', capabilities: 'Interactive', longDesc: 'Book tickets for movies, concerts, and live events.' },
  ...
  { id: 'district', name: 'District', iconText: 'D', iconBg: '#FF4500', iconColor: '#FFFFFF', desc: 'Quick Commerce & Grocery', category: 'Lifestyle', developer: 'District App', website: 'district.app', version: '1.0.0', capabilities: 'Interactive', longDesc: 'Get groceries and essentials delivered in 10 minutes.' },
  ...
  { id: 'flipkart', name: 'Flipkart', iconText: 'F', iconBg: '#2874F0', iconColor: '#FFE500', desc: 'The Big Billion Shop', category: 'Lifestyle', developer: 'Flipkart', website: 'flipkart.com', version: '3.5.0', capabilities: 'Interactive', longDesc: 'Search electronics, fashion, and more across India.' },
  { id: 'myntra', name: 'Myntra', iconText: 'M', iconBg: '#FF3F6C', iconColor: '#FFFFFF', desc: 'Fashion & Lifestyle', category: 'Lifestyle', developer: 'Myntra Designs', website: 'myntra.com', version: '2.2.0', capabilities: 'Interactive', longDesc: 'Discover the latest fashion trends and clothing.' },
  { id: 'meesho', name: 'Meesho', iconText: 'M', iconBg: '#F43397', iconColor: '#FFFFFF', desc: 'Lowest Prices on Fashion', category: 'Lifestyle', developer: 'Meesho', website: 'meesho.com', version: '1.8.0', capabilities: 'Interactive', longDesc: 'Resell and buy fashion at wholesale prices.' },
